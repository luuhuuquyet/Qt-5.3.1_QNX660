...
set(Qt5WebSockets_VERSION_STRING 5.3.1)
...
if (NOT TARGET Qt5::WebSockets)
    ...
    set(_Qt5WebSockets_MODULE_DEPENDENCIES "Sql;Network;Core")
    ...
    foreach(_module_dep ${_Qt5WebSockets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.3.1 ${_Qt5WebSockets_FIND_VERSION_EXACT}
    ...
    set(_Qt5WebSockets_LIB_DEPENDENCIES "Qt5::Sql;Qt5::Network;Qt5::Core")
    ...
    _populate_WebSockets_target_properties(RELEASE "libQt5WebSockets.so.5.3.1" "" )
