...
set(Qt5Enginio_VERSION_STRING 1.0.5)
...
if (NOT TARGET Qt5::Enginio)
    ...
    set(_Qt5Enginio_MODULE_DEPENDENCIES "Network;Gui;Core")
    ...
    foreach(_module_dep ${_Qt5Enginio_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                1.0.5 ${_Qt5Enginio_FIND_VERSION_EXACT}
    ...
    set(_Qt5Enginio_LIB_DEPENDENCIES "Qt5::Network;Qt5::Gui;Qt5::Core")
    ...
    _populate_Enginio_target_properties(RELEASE "libQt1Enginio.so.1.0.5" "" )
